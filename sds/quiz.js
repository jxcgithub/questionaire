...
var sdsQuizMaster = (function () {
	...
	function submitHandler(e) {
		...
		$.ajax({
            ...
            data: {"id":id,"score":score,"type":"SDS"},
            dataType: "json",
	...
	function displayQuiz(status) {
		...
		if(current.state === "introduction") {
            ...
            html = "<h2>完成!</h2><p>得分： "+current.score+"</p><p>*标准分为总分乘以1.25后所得的整数部分,我国以SDS标准分≥50为有抑郁症状。</p>" + submitButton();
			displayDom.html(html).trigger('create');
